...
const Footer = () => {
  return (
    <footer className="bg-main-2 ">
      <div className="container mx-5/6 flex p-5 justify-center text-xs font-medium text-brand gap-x-20">
          <div className="flex flex-col gap-y-4">
            {links.map((link, key) => (
              <Link to={'/' + link === 'Home' ? '' : link.toLowerCase()} key={key}>{link}</Link>
      ...
      <div className="container mx-auto w-5/6 flex justify-between items-center p-5 border-t border-brand">


          <div className="flex items-center gap-x-6 text-brand text-xs font-medium">
